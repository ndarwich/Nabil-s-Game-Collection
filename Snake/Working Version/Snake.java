...
public class Snake extends JFrame implements KeyListener, ActionListener{
  ...
  public void updateCells(){
    ...
    tiles[headCoords[0]][headCoords[1]].removeAll();
    tiles[headCoords[0]][headCoords[1]].setBackground(Color.GREEN);
    tiles[bodyCoords[0]][bodyCoords[1]].setBackground(Color.GREEN);
    tiles[tailCoords[0]][tailCoords[1]].setBackground(Color.GREEN);
